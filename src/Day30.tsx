...
const Day30 = () => {
  ...
  // Updated to use API data fetching for 30-day loans with date range
    ...
    <div className="p-4 bg-white flex flex-col w-full">
      <div className="flex h-screen">
        <div className="flex-grow p-4 bg-white">
          ...
          <DashboardCard title="30-Day Loan Disbursements (Total Across All Amounts)">
          ...
          <DashboardCard title="30-Day Loan Recovery Performance (Total Across All Amounts)">
            <ResponsiveContainer width="100%" height={300}>
              <BarChart data={chartData}>
                <CartesianGrid strokeDasharray="3 3" />
                <XAxis dataKey="Date" />
          ...
          <DashboardCard title="30-Day Loan Daily Revenue (Total Across All Amounts)">
            <ResponsiveContainer width="100%" height={300}>
          ...
          <DashboardCard title="30-Day Loan NPL (Total Across All Amounts)">
            <ResponsiveContainer width="100%" height={300}>
          ...
          <DashboardCard title="30-Day Daily Unique Users">
            <ResponsiveContainer width="100%" height={300}>
          ...
          <DashboardCard title="30-Day User Activity & Qualified Base">
