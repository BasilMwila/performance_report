...
// Sample raw data (You should replace this with actual CSV data)
const rawData = [
  {
    "Date": "1/01/2025",
...
// day,
//   nplRate: (
//     ((parseFloat(day["Gross Lent"]) - parseFloat(day["Gross Recovered"])) /
//       parseFloat(day["Gross Lent"])) *
//     100
//   ).toFixed(2),
// }));
...
const App = () => {
  ...
  <DashboardCard title="User Trends" className="w-full">
  ...
  <DashboardCard title="Daily Disbursements" className="w-full">
    <ResponsiveContainer width="100%" height={300}>
  ...
  <DashboardCard title="Daily Recoveries" className="w-full">
    <ResponsiveContainer width="100%" height={300}>
      <BarChart data={rawData}>
        <CartesianGrid strokeDasharray="3 3" />
        <XAxis dataKey="Date" />
  ...
  <DashboardCard title="Revenue Trends" className="w-full">
    <ResponsiveContainer width="100%" height={300}>
  ...
  {/* <DashboardCard title="NPL Rate Trend" className="w-full">
    <ResponsiveContainer width="100%" height={300}>
      <LineChart data={processedData}>
        <CartesianGrid strokeDasharray="3 3" />
        <XAxis dataKey="Date" />
        <YAxis domain={[-100, 100]} tickFormatter={(tick) => `${tick}%`} />
        <Tooltip formatter={(value) => `${value}%`} />
        <Legend />
        <Line type="monotone" dataKey="nplRate" stroke="#ff7300" />
      </LineChart>
    </ResponsiveContainer>
  </DashboardCard> */}

  <DashboardCard title="Total NPL Distribution" className="w-full">
    <ResponsiveContainer width="100%" height={300}>
      <PieChart>
        <Pie
          data={[
