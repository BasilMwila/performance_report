...
const Day21 = () => {
  ...
  // Updated to use API data fetching for 21-day loans with date range
      ...
      <div className="p-4 bg-white flex flex-col w-full">
        <div className="flex-grow p-4 bg-white">
          <h1 className="text-2xl font-bold mb-6 text-center text-green-700 w-full">
            21 Day Loan Performance Dashboard
          </h1>
    ...
    <div className="p-4 bg-white flex flex-col w-full">
      <div className="flex h-screen">
        <div className="flex-grow p-4 bg-white">
          ...
          <DashboardCard title="21-Day Loan Disbursements (Total Across All Amounts)">
          ...
          <DashboardCard title="21-Day Loan Recovery Performance (Total Across All Amounts)">
            <ResponsiveContainer width="100%" height={300}>
              <BarChart data={chartData}>
                <CartesianGrid strokeDasharray="3 3" />
                <XAxis dataKey="Date" />
          ...
          <DashboardCard title="21-Day Loan Daily Revenue (Total Across All Amounts)">
            <ResponsiveContainer width="100%" height={300}>
          ...
          <DashboardCard title="21-Day Loan NPL (Total Across All Amounts)">
            <ResponsiveContainer width="100%" height={300}>
          ...
          <DashboardCard title="21-Day Daily Unique Users">
            <ResponsiveContainer width="100%" height={300}>
          ...
          <DashboardCard title="21-Day User Activity & Qualified Base">
